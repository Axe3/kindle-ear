...
class Niuyueshibao(BaseFeedBook):
    title                 = u'纽约时报（电影）'
    description           = u'最新电影资讯。'
    language              = 'zh-cn'
    feed_encoding         = "utf-8"
    page_encoding         = "utf-8"
    mastheadfile          = "mh_niuyueshibao.gif"
    coverfile             = "cv_niuyueshibaomoive.jpg"
    oldest_article        = 1
    ...
    feeds = [ (u'Movies', SHARE_FUCK_GFW_SRV % urllib.quote('http://www.nytimes.com/services/xml/rss/nyt/Movies.xml'), True) ]
