...
class Niuyueshibao(BaseFeedBook):
    title                 = u'纽约时报（读书）'
    description           = u'读书是一件很有趣的事。'
    language              = 'zh-cn'
    feed_encoding         = "utf-8"
    page_encoding         = "utf-8"
    mastheadfile          = "mh_niuyueshibao.gif"
    coverfile             = "cv_niuyueshibaobooks.jpg"
    oldest_article        = 1
    ...
    feeds = [ (u'Reading', SHARE_FUCK_GFW_SRV % urllib.quote('http://www.nytimes.com/services/xml/rss/nyt/Books.xml'), True) ]
