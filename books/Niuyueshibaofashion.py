...
class Niuyueshibao(BaseFeedBook):
    title                 = u'纽约时报（时尚）'
    description           = u'最新时尚资讯。'
    language              = 'zh-cn'
    feed_encoding         = "utf-8"
    page_encoding         = "utf-8"
    mastheadfile          = "mh_niuyueshibao.gif"
    coverfile             = "cv_niuyueshibaofashion.jpg"
    oldest_article        = 1
    ...
    feeds = [ (u'Fashion', SHARE_FUCK_GFW_SRV % urllib.quote('http://www.nytimes.com/services/xml/rss/nyt/FashionandStyle.xml'), True) ]
