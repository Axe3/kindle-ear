...
class Xueqiu(BaseFeedBook):
    title                 = u'纽约时报（经济）'
    description           = u'每天最新经济要闻推送。'
    language              = 'zh-cn'
    feed_encoding         = "utf-8"
    page_encoding         = "utf-8"
    mastheadfile          = "mh_niuyueshibao.gif"
    coverfile             = "cv_niuyueshibaojingji.jpg"
    oldest_article        = 1
    ...
    feeds = [ (u'经济要闻', SHARE_FUCK_GFW_SRV % urllib.quote('http://www.nytimes.com/services/xml/rss/nyt/Economy.xml'), True) ]
